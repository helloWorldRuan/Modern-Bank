...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col px-16`}>
      ...
      <div className='flex-[1.5] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10'>
        ...
        {footerLinks.map((footerLink) => (
          <div key={footerLink.key} className='flex flex-col ss:my-0 my-4 min-w-[150px]'>
            ...
            <h4 className='font-poppins font-medium text-[18px] leadng-[27px] text-white'>
              {footerLink.title}
            </h4>
    ...
    <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]'>
      <p className='font-poppins font-normal text-center text-[12px] leading-[20px] text-dimWhite' >
       Copyright © 2021 HooBank. All Rights Reserved | Developed by helloWorldRuan | Credits for JavaScript Mastery.
      </p>
