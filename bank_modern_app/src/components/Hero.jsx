...
const Hero = () => (
  <section id='home' className={`flex justify-between md:flex-row flex-col py-6`}>
    <div className={`flex ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>

        <img src={discount} alt="discount" className='w-[32px] h-[32px]' />

        <p className={`${styles.paragraph} ml-2 text-transform: uppercase`}>
    ...
    <div className={`w-[40%] ss:w-[100%] flex-1 flex ${styles.flexCenter} md:my-0 my-0 relative`}>
      <img src={robot} alt="billing" className='w-[100%] relative z-[5]´' />

      <div className='absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient '/>
      <div className='absolute z-[1] w-[30%] h-[80%] rounded-full bottom-40 white__gradient '/>
